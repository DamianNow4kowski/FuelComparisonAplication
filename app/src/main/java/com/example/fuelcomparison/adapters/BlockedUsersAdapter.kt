...
class BlockedUsersAdapter(private val context: Context) :
    RecyclerView.Adapter<BlockedUsersAdapter.ViewHolder?>() {
    private val blockedUsers: MutableList<UserData>
    ...
    override fun onBindViewHolder(
        ...
        val user: UserData = blockedUsers[position]
    ...
    fun addUsers(allUsers: List<UserData>) {
        ...
        blockedUsers.addAll(filteredUsers)
        notifyDataSetChanged()
    }
    ...
    init {
        blockedUsers = ArrayList<UserData>()
    }
